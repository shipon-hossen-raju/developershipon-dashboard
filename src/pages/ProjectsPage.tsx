  ...
  const handleSave = async () => {
    ...
    try {
      if (modal.mode === "create") {
        ...
        await updateProject({ id: modal.data.id, data: form }).unwrap();
  ...
  return (
    <div className="space-y-5">
      ...
      <Modal
        ...
        title={modal.mode === "create" ? "Add New Project" : "Edit Project"}
        size="xl"
        footer={
          <>
            <button
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FormField label="Frontend Stack" className="md:col-span-2">
            <TagInput
              tags={form.technologies.frontend ?? []}
              onChange={(t) =>
                setForm({
                  ...form,
                  technologies: { ...form.technologies, frontend: t },
                })
              }
          ...
          <FormField label="Backend Stack" className="md:col-span-2">
            <TagInput
              tags={form.technologies.backend ?? []}
              onChange={(t) =>
                setForm({
                  ...form,
                  technologies: { ...form.technologies, backend: t },
                })
              }
          ...
          <FormField label="Database" className="md:col-span-2">
            <TagInput
              tags={form.technologies.database ?? []}
              onChange={(t) =>
                setForm({
                  ...form,
                  technologies: { ...form.technologies, database: t },
                })
              }
          ...
          <FormField label="Key Features" className="md:col-span-2">
            <TagInput
              ...
              onChange={(t) => setForm({ ...form, keyFeatures: t })}
              placeholder="Stripe payments, JWT auth..."
            />
          </FormField>
          <FormField label="Challenges" className="md:col-span-2">
            <Textarea
              placeholder="What was the main challenge and how did you solve it?"
